...
f = open(sys.argv[1])	#TOM
f_sign1 = open(sys.argv[2])
f_sign2 = open(sys.argv[3])
mod = sys.argv[1].split("/")[-1].split("-")[0]
print mod
...
out = "/Users/jessicaxinhu/Documents/noa_bc_pilot/diffCoExpress_analysis/diffCoEx/with_vest/diffmodules/diffNetw_inweb/"
...
out1.write("node1\tnode2\tscore\tdiff\n")
for line in my_set:
